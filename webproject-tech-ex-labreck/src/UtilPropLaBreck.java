...
public class UtilPropLaBreck {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "E:\\School\\Software Engineering\\workspace4830\\Tech-Exercise-LaBreck\\webproject-tech-ex-labreck\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject-tech-ex-labreck/config.properties";
